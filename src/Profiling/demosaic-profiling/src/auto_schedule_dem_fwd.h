#ifndef HALIDE_____auto_schedule_dem_fwd_h
#define HALIDE_____auto_schedule_dem_fwd_h
#include <stdint.h>
...
int auto_schedule_dem_fwd(struct halide_buffer_t *_opencv_out_buffer, struct halide_buffer_t *_processed_buffer) HALIDE_FUNCTION_ATTRS;
int auto_schedule_dem_fwd_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *auto_schedule_dem_fwd_metadata() HALIDE_FUNCTION_ATTRS;
